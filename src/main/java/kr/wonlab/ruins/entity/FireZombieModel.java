...
public class FireZombieModel<T extends ZombieEntity> extends ZombieEntityModel<T> {
    public FireZombieModel(float f, float g, int i, int j) {
        super(f, g, i, j);
    ...
    public FireZombieModel(float f, boolean bl) {
